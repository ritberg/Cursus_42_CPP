...
Dog::Dog(void) : Animal()
{
    this->type = VIOLET "🟣 This is a dog" RESET;
    std::cout << VIOLET "🟣 From Dog. Default constructor called" RESET << std::endl;
    return;
}

Dog::Dog(std::string DogType) : Animal("Two")
{
    this->type = VIOLET "🟣 This is a dog" RESET;
    std::cout << VIOLET "🟣 From Dog. Default constructor for " << DogType << " called" << std::endl;
    return;
}
...
{
    std::cout << VIOLET "🟣 From Dog: gaffe " RESET << std::endl;
    return;
}

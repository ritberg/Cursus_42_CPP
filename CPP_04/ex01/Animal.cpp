...
Animal::Animal(void) : type("⚪️ Animal")
{
    std::cout << "⚪️ From Animal. Default constructor called" << std::endl;
    return;
}

Animal::Animal(std::string AnimalType) : type("⚪️ " + AnimalType + " is an animal")
{
    std::cout << "⚪️ From Animal. Str constructor for " << AnimalType << " called" << std::endl;
    return;
}

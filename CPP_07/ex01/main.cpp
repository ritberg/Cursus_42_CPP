...
iterPrint without <> is also possible, implicit conversion
*/
...
int main()
{
    ...
    std::cout << std::endl << GREY "::iterPrint(*tab) - no for loop, only the first element is printed" RESET << std::endl;
    ::iterPrint(*tab);
